...
function About() {
    return (
        <section id="about" className="bg-gradient-to-r from-gray-600 to-gray-900 pt-10" style={{zIndex: `1`}}>
            <h2 className="text-center text-xl font-bp;d text-gray-300">About Me</h2>
            <ul className="grid p-10 gap-10 md:grid-cols-3">
                <li className="transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-110 bg-night-900 shadow rounded-lg overflow-hidden">
